/* tailwind-config.js — Shared Tailwind CSS configuration for fudami landing
   Loaded before Tailwind CDN processes the page. */
...
window.tailwind = {
  config: {
    ...
    theme: {
      extend: {
        colors: {
          // Brand palette — mapped to CSS variables for opacity support
